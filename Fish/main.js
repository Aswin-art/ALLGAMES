...
//     constructor(game){
//         this.game = game
//         this.swimLeft = new Image()
//         this.swimLeft.src = './assets/images/fish-swim-left.png'
//         this.swimRight = new Image()
//         this.swimRight.src = './assets/images/fish-swim-right.png'
//         this.x = canvas.width
//         this.y = canvas.height / 2
//         this.spriteWidth = 498
//         this.spriteHeight = 327
...
//         ctx.rotate(this.angle)
//         if(this.x >= this.game.event.mouse.x){
//             ctx.drawImage(this.swimLeft, this.frame * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight, 0 - 60, 0 - 60, this.spriteWidth / 3, this.spriteHeight / 3)
//         }else{
//             ctx.drawImage(this.swimRight, this.frame * this.spriteWidth, 0, this.spriteWidth, this.spriteHeight, 0 - 60, 0 - 60, this.spriteWidth / 3, this.spriteHeight / 3)
//         }
//         ctx.restore()
//     }
